...
# concept: Dishes
**concept** Dishes [User, Recipe]

**purpose** provide a stable identity and high-level categorization for a dish, together with a history of its recorded recipe attempts.

**principle** over time, a person uses dishes as named anchors for the meals they care about. When they decide they want to track a dish, they create a dish entry with a recognizable name and description. Each time they cook it, they add a new recipe attempt to the dish, building a reviewable history.
...
# file: src/concepts/Dishes/DishesConcept.ts
```typescript
